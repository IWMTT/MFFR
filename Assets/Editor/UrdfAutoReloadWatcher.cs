...
public static class UrdfAutoReloadWatcher
{
    ...
    static string urdfPath = "Assets/mcp_robot2/test_robot.urdf";
    static string meshFolder = "Assets/mcp_robot2/meshes";
    ...
    private static void ReloadUrdfModel()
    {
        ...
        string assetPath = "Assets/mcp_robot2/test_robot.urdf";

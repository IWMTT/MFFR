...
# gnome-terminal ショートカット作成
GNOME_TERM_DESKTOP="$HOME/Desktop/gnome-terminal.desktop"
cat << EOF > "$GNOME_TERM_DESKTOP"
[Desktop Entry]
Name=Terminal
...
chmod +x "$GNOME_TERM_DESKTOP"
chown "$USER:$USER" "$GNOME_TERM_DESKTOP"
